...
const Search = () => {
  ...
  //If there is a location value, return the label of the location value
  ...
  //If there duration, return the duration label
  ...
  //If there is a guest count, return the guest count label
